...
SCHEDULER_PROFILE = 0x10
TABLE_LISTENER_PROFILE = 0x20

ALL_PROFILES = WEB_PROFILE | PUBSUB_POLLER_PROFILE | LIVE_AGENT_PROCESSOR_PROFILE | PUSH_NOTIFIER_PROFILE | SCHEDULER_PROFILE | TABLE_LISTENER_PROFILE

NON_SCHEDULER_PROFILES = ALL_PROFILES ^ SCHEDULER_PROFILE
NON_TABLE_LISTENER_PROFILES = ALL_PROFILES ^ TABLE_LISTENER_PROFILE
...
__profile_entries = {
    ...
    "table-listener": TABLE_LISTENER_PROFILE
}
